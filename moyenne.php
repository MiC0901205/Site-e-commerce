...
try{ 
	...
	$sql = $db->prepare('SELECT b.idProduit, c.valeurCateg, Prix, Couleur, Image, Poids, Nom, Largeur, Longueur, Hauteur, description FROM batterie b JOIN categorie c on c.idCateg = b.idCateg JOIN produit p on p.idProduit = b.idProduit WHERE Largeur * Longueur * Hauteur > ? AND  Largeur * Longueur * Hauteur <= ?'); 
	$sql->execute(array("1000", "5000"));  
...
<link rel="stylesheet" href="./css/ronde.css">
	<h1> batteries taille moyenne</h1>
	<div class="imgR">
