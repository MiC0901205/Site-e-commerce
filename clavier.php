...
try{ 
	...
	$sql = $db->prepare('SELECT idProduit, c.valeurCateg, Prix, Couleur, Image, Poids, Nom, Largeur, Longueur, Hauteur, description FROM produit WHERE type LIKE ?'); 
	$sql->execute(array("Clavier"));
