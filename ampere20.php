...
try{ 
	...
	$sql = $db->prepare('SELECT b.idProduit, c.valeurCateg, Capacite, Prix, Couleur, Image, Poids, Nom, Largeur, Longueur, Hauteur, description FROM batterie b JOIN categorie c on c.idCateg = b.idCateg JOIN produit p on p.idProduit = b.idProduit WHERE Capacite > ? AND Capacite <= ?'); 
	$sql->execute(array("5000", "20000"));
...
<link rel="stylesheet" href="./css/ronde.css">
	<h1> Batteries entre 5000 et 10000 ampères </h1>
	<div class="imgR">
